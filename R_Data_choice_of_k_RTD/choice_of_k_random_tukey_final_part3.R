...
proj.seq <- seq(10,n.proj, length = n.proj/10)
...
# saveRDS(result.matrix.final, file = "./MT_functions/R_Data_choice_of_k_RTD/result.matrix.final.part3.rds")
# saveRDS(k.zero.final, file = "./MT_functions/R_Data_choice_of_k_RTD/k.zero.final.part3.rds")
