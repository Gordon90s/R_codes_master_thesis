...
proj.seq <- seq(1,n.proj, length = n.proj/1)
...
# saveRDS(result.matrix.final, file = "./MT_functions/R_Data_choice_of_k_RTD/result.matrix.final.part2.rds")
# saveRDS(k.zero.final, file = "./MT_functions/R_Data_choice_of_k_RTD/k.zero.final.part2.rds")

# uncomment to load 

# readRDS("./MT_functions/R_Data_choice_of_k_RTD/result.matrix.final.part2.rds")
# readRDS("./MT_functions/R_Data_choice_of_k_RTD/k.zero.final.part2.rds")
