...
# GOOD NEWS: for the functional random projeciton depth, the work is reproducible as the function depth.RT
  # allows to set a seed
  
n.draws.all <- c(100,200)
...
# saveRDS(result.matrix.final, file = "./MT_functions/R_Data_choice_of_k_FRPD/result.matrix.final.FRPD.part1.rds")
# saveRDS(k.zero.final, file = "./MT_functions/R_Data_choice_of_k_FRPD/k.zero.final.FRPD.part1.rds")

# uncomment to load 

# readRDS("./MT_functions/R_Data_choice_of_k_FRPD/result.matrix.final.FRPD.part1.rds")
# readRDS("./MT_functions/R_Data_choice_of_k_FRPD/k.zero.final.FRPD.part1.rds")
