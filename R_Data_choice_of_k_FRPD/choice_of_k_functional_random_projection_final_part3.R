...
# saveRDS(result.matrix.final, file = "./MT_functions/R_Data_choice_of_k_FRPD/result.matrix.final.FRPD.part3.rds")
# saveRDS(k.zero.final, file = "./MT_functions/R_Data_choice_of_k_FRPD/k.zero.final.FRPD.part3.rds")

# uncomment to load 

# readRDS("./MT_functions/R_Data_choice_of_k_FRPD/result.matrix.final.FRPD.part3.rds")
# readRDS("./MT_functions/R_Data_choice_of_k_FRPD/k.zero.final.FRPD.part3.rds")
